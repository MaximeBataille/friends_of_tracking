...
competitions <- fromJSON(file="C:/Users/Admin/R-projects/football/open-data-master/data/competitions.json")
...
####Obtain Matches####
match.files <- list.files(path="C:/Users/Admin/R-projects/football/open-data-master/data/matches",
...
####Obtain Events####
event.files <- list.files(path="C:/Users/Admin/R-projects/football/open-data-master/data/events",
                          full.names = TRUE,recursive = TRUE)
...
source("C:/Users/Admin/R-projects/football/cours_1/Draw_Pitch.R") #load in hori5, which contains the soccer field
